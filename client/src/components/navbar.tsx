            ...
            {isAuthenticated && (
              <>
                <Link
                  href="/history"
                  className={`${
                    location === "/history" ? "text-primary" : "text-gray-700"
                  } hover:text-primary px-3 py-2 text-sm font-medium`}
                >
                  My History
                </Link>
                <Link
                  href="/profile"
                  className={`${
                    location === "/profile" ? "text-primary" : "text-gray-700"
                  } hover:text-primary px-3 py-2 text-sm font-medium`}
                >
                  Profile
                </Link>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="ghost"
                      className="glass flex items-center text-gray-700 hover:text-primary px-3 py-2 rounded-full text-sm font-medium"
                    >
        ...
        <div className="sm:hidden glass">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link
              ...
              className={`${
                location === "/" ? "text-primary" : "text-gray-700"
              } hover:text-primary block px-3 py-2 rounded-md text-base font-medium`}
              onClick={closeMenu}
            >
              Home
            </Link>
